...
- Name: auth\LoginValidation.spec.ts >> LoginWithValidCredentialsSucceeds
- Location: tests\auth\LoginValidation.spec.ts:116:5
...
Call log:
  - navigating to "https://dev.admin.avtoikonom.com/login", waiting until "load"
